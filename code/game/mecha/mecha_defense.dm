...
/obj/mecha/bullet_act(obj/item/projectile/Proj) //wrapper
	if (!enclosed && occupant && !silicon_pilot && (Proj.def_zone == BODY_ZONE_HEAD || Proj.def_zone == BODY_ZONE_CHEST)) //allows bullets to hit the pilot of open-canopy mechs
